 ...
 * @author danie
 */
public class MediadorSeda implements Mediador{
    ...
    public MediadorSeda(Tambor tambor, ValvulaAgua valvulaAgua, ValvulaJabon valvulaJabon, ValvulaSuavizante valvulaSuavizante,  Motor motor, Escotilla escotilla){
        this.tambor = tambor;
